...
import { FaChevronLeft, FaChevronRight, FaCodeBranch, FaEye, FaStar } from 'react-icons/fa'
        ...
        {repositories.map((repo) => (
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] bg-gradient-to-br from-white/30 to-white/0 opacity-30 rotate-30" />
            </div>
