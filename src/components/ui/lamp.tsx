...
export function LampContainer({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-dark-950 w-full rounded-md z-0',
        className,
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-orange-500 opacity-50 blur-3xl" />
        <motion.div
          initial={{ width: '8rem' }}
      ...
      <div className="relative z-50 flex -translate-y-100 flex-col items-center px-20">
        {children}
      </div>
    </div>
  )
